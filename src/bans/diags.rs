...
crate::simple_enum!(
    ...
    [
        ...
        Skipped = "skipped",
        Wildcard = "wildcard",
        UnmatchedSkip = "unmatched-skip",
        UnnecessarySkip = "unnecessary-skip",
        AllowedByWrapper = "allowed-by-wrapper",
        UnmatchedWrapper = "unmatched-wrapper",
        SkippedByRoot = "skipped-by-root",
        UnmatchedSkipRoot = "unmatched-skip-root",
        BuildScriptNotAllowed = "build-script-not-allowed",
        ExactFeaturesMismatch = "exact-features-mismatch",
        FeatureNotExplicitlyAllowed = "feature-not-explicitly-allowed",
        FeatureBanned = "feature-banned",
        UnknownFeature = "unknown-feature",
        DefaultFeatureEnabled = "default-feature-enabled",
        PathBypassed = "path-bypassed",
        PathBypassedByGlob = "path-bypassed-by-glob",
        ChecksumMatch = "checksum-match",
        ChecksumMismatch = "checksum-mismatch",
        DeniedByExtension = "denied-by-extension",
        DetectedExecutable = "detected-executable",
        DetectedExecutableScript = "detected-executable-script",
        UnableToCheckPath = "unable-to-check-path",
        ...
        UnusedWorkspaceDependency = "unused-workspace-dependency",
        NonUtf8Path = "non-utf8-path",
        NonRootPath = "non-root-path",
        ReplacedInStd = "replaced-in-std",
        UnmatchedReplacementIgnore = "unmatched-replacement-ignore",
    ]
);
